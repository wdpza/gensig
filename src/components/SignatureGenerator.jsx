  ...
  return (
    <div>
        <form onSubmit={handleSubmit(generateSignature)} className="space-y-4 mb-5">
            <input required {...register("name")} placeholder="Name" className="p-2 w-full border rounded text-slate-600" />
            <input required {...register("role")} placeholder="Role" className="p-2 w-full border rounded text-slate-600" />
            <input required {...register("tel")} placeholder="Telephone" className="p-2 w-full border rounded text-slate-600" />
            <input required {...register("mobile")} placeholder="Mobile" className="p-2 w-full border rounded text-slate-600" />
            <input required {...register("email")} placeholder="Email" className="p-2 w-full border rounded text-slate-600" />
            <input required {...register("websiteUrl")} placeholder="Website URL" className="p-2 w-full border rounded text-slate-600" value="https://brandwagon.co.za" />
            <input required {...register("websiteDisplay")} placeholder="Website Display Name" className="p-2 w-full border rounded text-slate-600" value="brandwagon.co.za" />
            <input required {...register("bannerImage")} placeholder="Banner Image URL" className="p-2 w-full border rounded text-slate-600" value="https://brandwagon.co.za/images/sig-banner.png" />
